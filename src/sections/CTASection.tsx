...
const CTASection: React.FC = () => {
  ...
  return (
    <section
      id="cta"
      style={{ position: 'relative', background: '#07111F', padding: '0 0 80px', overflow: 'hidden' }}
      aria-label="Call to action"
    >
      {/* top divider */}
      <div style={{
        height: 1, background: 'linear-gradient(90deg,transparent,rgba(62,143,168,.16),transparent)',
      }} aria-hidden="true" />
      ...
      <div style={{
        ...
        background:
          'radial-gradient(ellipse at 25% 50%, rgba(62,143,168,.055) 0%, transparent 55%),' +
          'radial-gradient(ellipse at 80% 50%, rgba(62,143,168,.035) 0%, transparent 50%)',
        filter: 'blur(30px)',
      }} aria-hidden="true" />
      ...
      <div className="cta-container">
        ...
        <div style={{
          position: 'relative',
          background: '#0E1E30',
          border: '1px solid rgba(62,143,168,.12)',
          borderRadius: '16px',
          overflow: 'hidden',
          boxShadow: '0 0 80px rgba(62,143,168,.05)',
        }}>
          {/* corner glows */}
          <div style={{
            position: 'absolute', top: 0, right: 0, width: 280, height: 280, pointerEvents: 'none',
            background: 'radial-gradient(ellipse at top right, rgba(62,143,168,.09) 0%, transparent 65%)',
          }} />
          <div style={{
            position: 'absolute', bottom: 0, left: 0, width: 220, height: 220, pointerEvents: 'none',
            background: 'radial-gradient(ellipse at bottom left, rgba(62,143,168,.055) 0%, transparent 65%)',
          }} />
                  ...
                  <ul style={{ display: 'flex', flexDirection: 'column', gap: '11px' }} aria-label="Benefits">
                    {features.map(f => (
                      <li key={f} style={{
                        ...
                        <Check size={13} style={{ color: '#3E8FA8', flexShrink: 0 }} />
                        {f}
                      </li>
                    ))}
                  </ul>
                  ...
                  <div>
                    ...
                    <p style={{
                      ...
                      <a href="mailto:saimokshith2006@gmail.com" style={{
                        color: '#3E8FA8', textDecoration: 'none', transition: 'color .2s',
                      }}>
