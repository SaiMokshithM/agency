...
const faqs = [
  {
    q: 'What does VELOtechnoz do?',
    a: 'VELOtechnoz is a private product design and engineering studio. We build custom digital products — from high-performance websites and SaaS platforms to AI-powered automation systems — for forward-thinking companies that refuse to accept average.',
  },
  {
            ...
            <div className="about-header-right">
              <ScrollReveal animation="fadeUp" delay={0.12}>
                <p className="about-body">
                  VELOtechnoz is a private product design and engineering studio.
          ...
          <div className="about-quote">
            <div className="about-quote-inner">
              ...
              <div className="about-quote-content">
                ...
                <cite className="about-quote-cite">— VELOtechnoz Studio Creed</cite>
              </div>
            </div>
          </div>
        </ScrollReveal>
